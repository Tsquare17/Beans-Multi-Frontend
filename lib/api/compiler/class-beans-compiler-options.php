...
final class _Beans_Compiler_Options {
	...
	public function register() {
		return Options\beans_register_options(
	...
	private function is_not_supported( $component ) {
		return ! API\beans_get_component_support( $component );
	}
	...
	public function flush() {
		...
		if ( ! Utilities\beans_post( 'beans_flush_compiler_cache' ) ) {
			return;
		}

		Utilities\beans_remove_dir( beans_get_compiler_dir() );
	}
	...
	public function render_styles_not_compiled_notice() {
		...
		$message = __( 'Styles are not compiled in development mode.', 'beans' );
	...
	public function render_scripts_not_compiled_notice() {
		...
		$message = __( 'Scripts are not compiled in development mode.', 'beans' );
