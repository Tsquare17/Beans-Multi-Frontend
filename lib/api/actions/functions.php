...
namespace Beans\Framework\API\Actions;
...
function _beans_get_action( $id, $status ) {
	...
	$registered_actions = Utilities\beans_get( $status, $_beans_registered_actions );
	...
	$action = Utilities\beans_get( $id, $registered_actions );
