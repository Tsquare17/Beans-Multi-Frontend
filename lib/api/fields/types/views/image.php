...
use function Beans\Framework\API\Utilities\beans_esc_attributes;
...
?>
	<div class="bs-image-wrap<?php echo 'placeholder' === $image_id ? ' bs-image-template' : ''; ?>">
		...
		<div class="bs-toolbar">
			...
			?>
		<?php if ( $is_multiple ) : ?>
			<button aria-label="<?php esc_attr_e( 'Manage Images', 'beans' ); ?>" type="button" class="button bs-button-menu dashicons dashicons-menu"></button>
		<?php endif; ?>
			<button aria-label="<?php esc_attr_e( 'Edit Image', 'beans' ); ?>" type="button" class="button bs-button-edit dashicons dashicons-edit"></button>
			<button aria-label="<?php esc_attr_e( 'Delete Image', 'beans' ); ?>" type="button" class="button bs-button-trash dashicons dashicons-post-trash"></button>
		</div>
	</div>
<?php endforeach; ?>
</div>
