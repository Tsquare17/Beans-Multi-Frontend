...
Actions\beans_add_smart_action( 'beans_field_enqueue_scripts_slider', __NAMESPACE__ . '\beans_field_slider_assets' );
/**
...
Actions\beans_add_smart_action( 'beans_field_slider', __NAMESPACE__ . '\beans_field_slider' );
/**
