...
Actions\beans_add_smart_action( 'beans_field_checkbox', __NAMESPACE__ . '\beans_field_checkbox' );
/**
 * Echo checkbox field.
 *
 * @since 1.0.0
...
function beans_field_checkbox( array $field ) {
	$checkbox_label = Utilities\beans_get( 'checkbox_label', $field, __( 'Enable', 'beans' ) );
