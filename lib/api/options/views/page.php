...
<form action="" method="post" class="bs-options" data-page="<?php echo esc_attr( Utilities\beans_get( 'page' ) ); ?>">
	...
	<p class="bs-options-form-actions">
		<input type="submit" name="beans_save_options" value="<?php esc_attr_e( 'Save', 'beans' ); ?>" class="button-primary">
		<input type="submit" name="beans_reset_options" value="<?php esc_attr_e( 'Reset', 'beans' ); ?>" class="button-secondary">
	</p>
</form>
