...
final class _Beans_Post_Meta {
	...
	public function render_metabox_content() {
		...
		foreach ( Fields\beans_get_fields( 'post_meta', $this->section ) as $field ) {
	...
	public function save( $post_id ) {
		...
		if ( Utilities\_beans_doing_autosave() ) {
			return false;
		}
	...
	public function ok_to_save( $id, $fields ) {
		if ( ! wp_verify_nonce( Utilities\beans_post( 'beans_post_meta_nonce' ), 'beans_post_meta_nonce' ) ) {
			return false;
		}
