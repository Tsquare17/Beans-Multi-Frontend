...
namespace Beans\Framework\API\Image;
...
final class _Beans_Image_Options {
	...
	private function has_metaboxes() {
		...
		$metaboxes = Utilities\beans_get( 'beans_settings', $wp_meta_boxes );
	...
	public function flush() {
		...
		if ( ! Utilities\beans_post( 'beans_flush_edited_images' ) ) {
			return;
		}

		Utilities\beans_remove_dir( beans_get_images_dir() );
	}
