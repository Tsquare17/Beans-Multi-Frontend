...
namespace Beans\Framework\API\WP_Customize;
...
final class _Beans_WP_Customize {
	...
	public function __construct( $section, array $args ) {
		...
		HTML\beans_add_attribute( 'beans_field_label', 'class', 'customize-control-title' );
	}
	...
	private function add() {
		...
		$fields = Fields\beans_get_fields( 'wp_customize', $this->section );
	...
	private function add_setting( \WP_Customize_Manager $wp_customize, array $field ) {
		...
		$wp_customize->add_setting(
			$field['name'],
			array(
				'default'           => Utilities\beans_get( 'default', $field ),
				'type'              => $field['db_type'],
