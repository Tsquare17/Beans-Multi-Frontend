...
function beans_register_wp_customize_options( array $fields, $section, $args = array() ) {
	 ...
	 */
	$fields = apply_filters( "beans_wp_customize_fields_{$section}", Fields\_beans_pre_standardize_fields( $fields ) );
	...
	if ( ! Fields\beans_register_fields( $fields, 'wp_customize', $section ) ) {
		return false;
	}
