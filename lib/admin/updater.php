...
add_filter( 'site_transient_update_themes', __NAMESPACE__ . '\beans_updater' );
/**
...
function beans_updater( $value ) {
	...
	if ( version_compare( $current_version, Utilities\beans_get( 'version', $data ), '<' ) ) {
...
add_action( 'load-update-core.php', __NAMESPACE__ . '\beans_updater_clear_transient' );
/**
