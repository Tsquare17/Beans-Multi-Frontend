...
add_action( 'beans_init', __NAMESPACE__ . '\beans_define_constants', -1 );
/**
 * Define constants.
 *
 * @since 1.0.0
...
add_action( 'beans_init', __NAMESPACE__ . '\beans_load_dependencies', -1 );
/**
 * Load dependencies.
 *
 * @since 1.0.0
...
function beans_load_dependencies() {
	...
	API\beans_add_api_component_support( 'wp_styles_compiler' );
	API\beans_add_api_component_support( 'wp_scripts_compiler' );
...
add_action( 'beans_init', __NAMESPACE__ . '\beans_add_theme_support' );
/**
 * Add theme support.
 *
 * @since 1.0.0
...
add_action( 'beans_init', __NAMESPACE__ . '\beans_load_textdomain' );
/**
 * Load text domain.
 *
 * @since 1.0.0
