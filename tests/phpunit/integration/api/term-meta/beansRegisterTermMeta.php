...
class Tests_BeansRegisterTermMeta extends Term_Meta_Test_Case {
	...
	public function test_should_return_false_when_current_taxonomy_not_concerned() {
		$this->assertFalse( beans_register_term_meta( static::$test_data['fields'], [ 'sample-taxonomy' ], 'beans' ) );
	}
	...
	public function test_should_return_false_when_term_meta_fields_cannot_be_registered() {
		...
		$this->assertFalse( beans_register_term_meta( [], 'sample-taxonomy', 'beans' ) );
	}
